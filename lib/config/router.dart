...
final router = GoRouter(initialLocation: '/', routes: [
  ...
  GoRoute(path: '/register_screen', builder: (context, state) => const RegisterScreen()),
  GoRoute(path: '/login_screen', builder: (context, state) => const LoginScreen()),
  GoRoute(path: '/loan_dashboard_screen', builder: (context, state) => const LoanDashBoardScreen()),
  GoRoute(path: '/add_loan_screen', builder: (context, state) => const AddLoanScreen()),
  GoRoute(path: '/view_loan_screen', builder: (context, state) {
    final loadId = state.uri.queryParameters['loan_id'];
    return  ViewLoanScreen(loanId: loadId!,);
  }),
  GoRoute(path: '/search_loan_screen', builder: (context, state) => const SearchLoanScreen()),
]);
